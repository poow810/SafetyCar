...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\safety_package\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\safety_package\hook\ament_prefix_path.bat"
