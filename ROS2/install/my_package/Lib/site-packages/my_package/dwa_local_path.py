...
class advancedDWALocalPath(Node):
    ...
    def __init__(self):
        ...
        self.robot_pose = [0.0, 0.0, 0.0] # 로봇의 현재 위치
    ...
    def timer_callback(self):
        if self.is_odom and self.is_path and self.is_lidar:
            # x, config, goal, ob
            u, trajectory = dynamic_window_approach.dwa_control(self.robot_pose, dynamic_window_approach.Config(), self.goal_pose, self.obstacle)
