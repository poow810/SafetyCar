...
class astarLocalpath(Node):
    ...
    def __init__(self):
        ...
        self.local_path_pub = self.create_publisher(Path, 'local_path', qos_sensor)
        self.subscription = self.create_subscription(Path,'/global_path',self.path_callback, qos_sensor)
