...
from my_package.qos import qos_sensor
...
class Localization:
    ...
    def _prediction(self, diff_pose):
        ...
        delta_angle2 = diff_pose[2]/180.0*np.pi - delta_angle1
...
class Localizer(Node):
    ...
    def imu_callback(self,msg):
        ...
        if self.is_imu ==False :    
            ...
            # print("imuq : ", imu_q.to_euler()[2]*180/pi)
            # print("imuoffset : ", self.imu_offset[2]*180/pi)
    ...
    def init_pose_callback(self,msg):
        ...
        if msg.header.frame_id=='map' :
            ...
            print("initOdom : ", self.odom_theta*180/pi)
